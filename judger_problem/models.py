...
class Problem(models.Model):
    ...
    problem_test_case_input = models.TextField(default="", verbose_name="输入测试用例", help_text="以'///'分割多个数据")
    problem_test_case_output = models.TextField(default="", verbose_name="输出测试用例", help_text="以'///'分割多个数据")
